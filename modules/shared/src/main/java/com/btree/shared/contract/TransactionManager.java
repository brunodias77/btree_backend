...
public interface TransactionManager {
    ...
    /**
     * Agenda uma ação para executar somente após o commit da transação atual.
     * Implementações sem suporte transacional podem executar imediatamente.
     */
    default void afterCommit(final Runnable action) {
        action.run();
    }
}
