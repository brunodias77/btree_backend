...
public class UserError {
    ...
    public static final Error PASSWORD_WEAK = new Error("'password' deve possuir ao menos uma letra maiúscula, uma letra minúscula, um dígito numérico e um caractere especial");
